...
class Solution:
    def sortedArrayToBST(self, nums: List[int]) -> Optional[TreeNode]:
        ...
        The key point is 
        - in recursion call all the var remains to that particular function 
        lets say in this example the first l and r are 0 and len(nums) - 1 
        this remains same until the deep recursion call returns 
        once they come to back left and right will still be same 0 and len(nums)-1
        """
