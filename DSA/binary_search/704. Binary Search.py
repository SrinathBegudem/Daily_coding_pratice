class Solution:
    def search(self, nums: List[int], target: int) -> int:
        ...
        def iter_sol():
            ...
            right = n-1  #right is inclusive [left,right]
...
#wrong code look at intro code for all binary search patterns 
        ...
        #     left = 0
        #     right = n # ----> right is exclusive [left,right), we use (not n-1)
        ...
        # #l = 0, r = 4, mid = 2 # nums[mid] is not less than target its eq so else statement executed r = mid = 1
        # #l = 0 , r = 2 , mid = 1  else statements executed r = 1
        # #l=0 r = 1, mid = 0 if statement executes 
        # # l=r=1 loop breaks we return l or r  so we get the indx of first occurence 
        # #--------
